                ...
                try {
                    const response = await fetch('/admin/api/global-settings', {
                        ...
                        body: JSON.stringify({
                            ...
                            pressure_management_enabled: this.globalSettings.memory.pressure_management_enabled,
                            target_free_memory: this.globalSettings.memory.target_free_memory,
                            watermark_yellow: this.globalSettings.memory.watermark_yellow,
                            watermark_red: this.globalSettings.memory.watermark_red,
